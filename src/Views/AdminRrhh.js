...
export default function AdminRrhh() {
    ...
    const elegirTipoTramite = (event) => {
      setTipoTramite(event.target.value)
      getTurnosSuperAdmin(mesEnCalendario.toString(), {tipo: event.target.value}).then(data => {
          ...
          <TransitionsModal isVisible={visibleModal}>
            ...
            <FormControl className={classes.formControl}>
              ...
              <Select
                ...
                value={tipoTramite}
                onChange={elegirTipoTramite}
              >
                <MenuItem value="OC">Oficina Central</MenuItem>
                <MenuItem value="DPC">
                  Departamento de personal central
                </MenuItem>
                <MenuItem value="CDS">Certificaciones de servicios</MenuItem>
              </Select>
            </FormControl>
          <Calendars
